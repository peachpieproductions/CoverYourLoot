...
namespace EasyWiFi.ServerControls
{
    ...
    [AddComponentMenu("EasyWiFiController/Server/UserControls/Custom PinchZoom Touchpad")]
    public class CustomPinchZoomTouchpadServerController : MonoBehaviour, IServerController
    {
